...
class BoxInputFieldV2 extends StatefulWidget {
  ...
  @override
  _BoxInputFieldV2State createState() => _BoxInputFieldV2State();
}
...
class _BoxInputFieldV2State extends State<BoxInputFieldV2> {
  ...
  OutlineInputBorder get circleBorder => OutlineInputBorder(
        borderRadius: BorderRadius.circular(
            widget.isSmall ? 30 : 8), // Thay đổi kích thước borderRadius
      );
